...
<body>
	<div class="container-fluid py-6">
		<div class="row">
			<div class="col-lg-6">
  			<img class="logohome" src="<?php echo base_url("uploads/image/logoHome.png")?>">
			</div>
			<div class="col-lg-6">
  			<img class="laptop" src="<?php echo base_url("uploads/image/home.png")?>">
			</div>		
		</div>
