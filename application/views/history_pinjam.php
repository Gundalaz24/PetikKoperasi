...
<div class="sidebar">
  ...
  <li><a href="<?php base_url()?>anggota">ANGGOTA</a></li>
	...
	<li class="active"><a href="<?php base_url()?>history_pin">KETERANGAN PINJAMAN</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="aksi">
        ...
        <?php echo anchor('history_pin/hapus/'.$value->id_pinjam,'<i class="fa fa-trash btn btn-danger" aria-hidden="true"></i>'); ?>
      </td>
    </tr>
    <?php $count++ ?>
    <?php } ?>
